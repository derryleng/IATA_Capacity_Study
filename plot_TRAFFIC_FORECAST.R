plot_TRAFFIC_FORECAST <- function(entity, fontsize=12, years) {
  ...
  if (entity == "FABEC") {
    g <- g %>%
      add_trace(
        ...
        x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2015-L", legendgroup = "2015 Forecast",
      ...
      add_trace(
        ...
        x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2015-H", legendgroup = "2015 Forecast",
      ...
      add_trace(
        ...
        x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2015-B", legendgroup = "2015 Forecast",
    ...
    g <- g %>%
      add_trace(
        ...
        x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2014-L", legendgroup = "2014 Forecast",
        type="scatter", mode="lines", line = list(color = "#3690c0", dash = "dash")
      ) %>%
      add_trace(
        ...
        x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2014-H", legendgroup = "2014 Forecast",
        type="scatter", mode="lines", line = list(color = "#0570b0", dash = "dash"), fill = 'tonexty', fillcolor = "rgba(130, 177, 255, 0.7)"
      ) %>%
      add_trace(
        ...
        x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2014-B", legendgroup = "2014 Forecast",
        type="scatter", mode="lines", line = list(color = "#034e7b")
      )
  }
  ...
  g <- g %>%
    add_trace(
      ...
      x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2018-L", legendgroup = "2018 Forecast",
    ...
    add_trace(
      ...
      x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2018-H", legendgroup = "2018 Forecast",
    ...
    add_trace(
      ...
      x = ~factor(YEAR, levels=years_range_extended), y = ~TRAFFIC, name = "2018-B", legendgroup = "2018 Forecast",
